    ...
    <SidebarLayout
      ...
      sidebar={
        <Sidebar>
          ...
          <SidebarBody>
            <SidebarSection>
              <SidebarItem href="/leasing">
                <HomeIcon />
                <SidebarLabel>Home</SidebarLabel>
              </SidebarItem>
              <SidebarItem href="/leasing/property">
                <HomeModernIcon />
                <SidebarLabel>Properties</SidebarLabel>
              </SidebarItem>
              <SidebarItem href="/leasing/unit">
                <RectangleGroupIcon />
                <SidebarLabel>Units</SidebarLabel>
              </SidebarItem>
              <SidebarItem href="/leasing/advertisement">
                <MegaphoneIcon />
                <SidebarLabel>Advertisements</SidebarLabel>
              </SidebarItem>
              <SidebarItem href="/leasing/organization">
                <UserGroupIcon />
